...
W.HTP_NEW_GAMES = {
  ...
  poker:      { name: 'Poker', icon: 'PK', minStake: 10, desc: 'Texas Holdem 2-player showdown' },
  blackjack:  { name: 'Blackjack', icon: 'BJ', minStake: 5, desc: 'Player vs dealer, 21 wins' }
};

W.HTP_GAMES_LIST = ['chess','checkers','connect4','poker','blackjack','backgammon','rps','coinflip','wordduel'];
